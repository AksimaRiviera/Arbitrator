...
async Task HandleUpdateAsync(ITelegramBotClient botClient, Update update, CancellationToken cancellationToken)
{
    ...
    //        chatId: chatID,
    //        text: mainSynapse.Answer,
    //        parseMode: ParseMode.Html,
    //        replyMarkup: new ReplyKeyboardRemove(),
    //        cancellationToken: cancellationToken);
    //
    //if (mainSynapse.WhatKeyboard == MainSynapse.WhatKeyboardNeed.RePlay)
    //    sentMessage = await botClient.SendTextMessageAsync(
    //        chatId: chatID,
    //        text: mainSynapse.Answer,
    //        parseMode: ParseMode.Html,
    //        replyMarkup: mainSynapse.ReplyKeyboard,
    //        cancellationToken: cancellationToken);
    //
    //if (mainSynapse.WhatKeyboard == MainSynapse.WhatKeyboardNeed.InLine)
    //    sentMessage = await botClient.SendTextMessageAsync(
    //        chatId: chatID,
    //        text: mainSynapse.Answer,
    //        parseMode: ParseMode.Html,
    //        replyMarkup: mainSynapse.InlineKeyboard,
    //        cancellationToken: cancellationToken);
    //
    //if (mainSynapse.WhatKeyboard == MainSynapse.WhatKeyboardNeed.Remove) 
    //    sentMessage = await botClient.SendTextMessageAsync(
    //        chatId: chatID,
    //        text: mainSynapse.Answer,
    //        parseMode: ParseMode.Html,
    ...
    //{
    //    MainSynapse mainSynapse = new MainSynapse(botClient, update, cancellationToken);
    //    await Arbitrator.AnswerCallbackQueryAsync(
    ...
    //    sentMessage = await botClient.AnswerInlineQueryAsync(
    //               inlineQueryId: callback.Id,
    //               $"{mainSynapse.Answer}",
    //               cancellationToken: cancellationToken);
    //}
    //
